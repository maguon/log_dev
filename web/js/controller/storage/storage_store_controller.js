 ...
 */
app.controller("storage_store_controller", ["$scope", "$host", "$pass_parameter", "_basic", "$state", "$rootScope", "_config",  "service_storage_parking", function ($scope, $host, $pass_parameter, _basic, $state, $rootScope, _config, service_storage_parking) {
