...
data_controller.controller("dataController", ['$rootScope','$scope','$location','$q','$basic',"$host",
    ...
    function($rootScope,$scope,$location,$q,$basic ,$host) {
        ...
        var colObjs =[{name:'name',type:'number',length:10},{name:'age',type:'string',length:2},{name:'age',type:'string',length:2},{name:'age',type:'string',length:2},{name:'age',type:'string',length:2},{name:'age',type:'string',length:2},{name:'age',type:'string',length:2},{name:'age',type:'string',length:2},{name:'age',type:'string',length:2}];
        // 头部条件判断
